  ...
  return (
    <section className="py-20 mb-[-50px] relative z-20">
      <div className="container mx-auto px-6">
        <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl shadow-indigo-500/30 dark:shadow-indigo-900/40 flex flex-col items-center relative overflow-hidden transform hover:scale-[1.01] transition-transform duration-500">
